...
tools: ['edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'sequentialthinking/*', 'context7/*', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos', 'runSubagent', 'runTests']
---
...
- Strict TypeScript configuration and migration strategiesư
