...
tools: ['edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'com.figma.mcp/mcp/*', 'context7/*', 'shadcn-ui/*', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos', 'runSubagent', 'runTests']
---
